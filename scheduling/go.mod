module github.com/cobaltcore-dev/cortex/scheduling
...
require (
	github.com/cobaltcore-dev/cortex/decisions/api v0.0.0-20251023063201-2a0f914492eb
	github.com/cobaltcore-dev/cortex/knowledge/api v0.0.0-20251023063201-2a0f914492eb
	github.com/cobaltcore-dev/cortex/lib v0.0.0-00010101000000-000000000000
	github.com/cobaltcore-dev/cortex/reservations/api v0.0.0-20251023063201-2a0f914492eb
