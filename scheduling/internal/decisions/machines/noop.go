...
import (
	...
	ironcorev1alpha1 "github.com/cobaltcore-dev/cortex/scheduling/api/delegation/ironcore"
...
func (NoopFilter) Run(traceLog *slog.Logger, request ironcorev1alpha1.MachinePipelineRequest) (*lib.StepResult, error) {
