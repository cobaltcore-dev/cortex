...
type AvoidOverloadedHostsCPUStep struct {
	...
	lib.BaseStep[api.ExternalSchedulerRequest, AvoidOverloadedHostsCPUStepOpts]
}
...
func (s *AvoidOverloadedHostsCPUStep) Run(traceLog *slog.Logger, request api.ExternalSchedulerRequest) (*lib.StepResult, error) {
