...
func TestPlacementSyncer_Init(t *testing.T) {
	...
	conf := conf.SyncOpenStackPlacementConfig{Types: []string{"resource_providers", "traits"}}
...
func TestPlacementSyncer_SyncInventoryUsages(t *testing.T) {
	...
	mon := sync.Monitor{}
	pc := &testlibKeystone.MockKeystoneAPI{}
	conf := conf.SyncOpenStackPlacementConfig{Types: []string{"resource_providers", "traits", "inventory_usages"}}
