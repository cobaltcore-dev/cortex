...
type CPUUsageBalancingStep struct {
	...
	scheduler.BaseStep[api.ExternalSchedulerRequest, CPUUsageBalancingStepOpts]
}
...
func (s *CPUUsageBalancingStep) Run(traceLog *slog.Logger, request api.ExternalSchedulerRequest) (*scheduler.StepResult, error) {
