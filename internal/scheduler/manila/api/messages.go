...
type ExternalSchedulerRequest struct {
	...
	//
	// Simulated requests can be used to notify cortex that the share is not actually
	// being scheduled, but we still want to know which pool would be selected
	// if it were to schedule the share.
...
func (r ExternalSchedulerRequest) IsSimulated() bool {
	return r.Simulated
}
