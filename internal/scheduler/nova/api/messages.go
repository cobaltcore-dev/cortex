...
type ExternalSchedulerRequest struct {
	...
	//
	// Simulated requests can be used to notify cortex that the vm is not actually
	// being scheduled, but we still want to know which hosts would be selected
	// if it were to schedule the VM.
