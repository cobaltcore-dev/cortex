...
func TestFilterCorrectAZStep_Run(t *testing.T) {
	...
	hostAZs, err := v1alpha1.BoxFeatureList([]any{
		&compute.HostAZ{ComputeHost: "host1", AvailabilityZone: testlib.Ptr("az-1")},
		&compute.HostAZ{ComputeHost: "host2", AvailabilityZone: testlib.Ptr("az-1")},
		&compute.HostAZ{ComputeHost: "host3", AvailabilityZone: testlib.Ptr("az-2")},
		&compute.HostAZ{ComputeHost: "host4", AvailabilityZone: testlib.Ptr("az-3")},
		&compute.HostAZ{ComputeHost: "host5", AvailabilityZone: nil},
	})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
