...
func (f *NodeAvailableFilter) Validate(ctx context.Context, params v1alpha1.Parameters) error {
	return nil
}

func (NodeAvailableFilter) Run(traceLog *slog.Logger, request pods.PodPipelineRequest, opts lib.Options) (*lib.FilterWeigherPipelineStepResult, error) {
