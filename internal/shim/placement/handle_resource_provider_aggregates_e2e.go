...
// e2eTestResourceProviderAggregates is a passthrough scaffold for the
// /resource_providers/{uuid}/aggregates endpoints. Exercising them requires a
...
func e2eTestResourceProviderAggregates(ctx context.Context, _ client.Client) error {
	...
	log.Info("Running resource_provider_aggregates endpoint e2e test")
