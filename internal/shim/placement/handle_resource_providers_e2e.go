...
// e2eTestResourceProviders exercises GET /resource_providers as a passthrough
// to upstream placement, confirming the shim forwards the request and returns
// a 2xx status.
func e2eTestResourceProviders(ctx context.Context, _ client.Client) error {
	log := logf.FromContext(ctx)
	log.Info("Running resource_providers endpoint e2e test")
