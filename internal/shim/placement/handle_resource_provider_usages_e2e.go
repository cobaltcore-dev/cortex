...
// e2eTestResourceProviderUsages is a passthrough scaffold for the
// GET /resource_providers/{uuid}/usages endpoint. Exercising it requires a
...
func e2eTestResourceProviderUsages(ctx context.Context, _ client.Client) error {
	...
	log.Info("Running resource_provider_usages endpoint e2e test")
