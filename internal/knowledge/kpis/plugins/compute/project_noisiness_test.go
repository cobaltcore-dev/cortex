...
func TestVMwareProjectNoisinessKPI_Collect(t *testing.T) {
	...
	vropsProjectNoisiness, err := v1alpha1.BoxFeatureList([]any{
		&compute.VROpsProjectNoisiness{Project: "project1", ComputeHost: "host1", AvgCPUOfProject: 10.5},
		&compute.VROpsProjectNoisiness{Project: "project2", ComputeHost: "host2", AvgCPUOfProject: 15.0},
	})
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
