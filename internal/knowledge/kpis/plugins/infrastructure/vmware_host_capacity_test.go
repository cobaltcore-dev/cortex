	...
	tests := []struct {
	...
	}{
		{
			...
			expectedMetrics: []collectedVMwareMetric{
				...
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "cpu"), Value: 8},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "ram"), Value: 4096 * 1024 * 1024},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "disk"), Value: 250 * 1024 * 1024 * 1024},
		...
		},
		{
			...
			utilizations: []compute.HostUtilization{
				{ComputeHost: "nova-compute-1", VCPUsUsed: 2, PhysicalVCPUs: 4, TotalVCPUsAllocatable: 8, RAMUsedMB: 512, PhysicalRAMMB: 1024, TotalRAMAllocatableMB: 2048, DiskUsedGB: 10, PhysicalDiskGB: 50, TotalDiskAllocatableGB: 100},
				{ComputeHost: "nova-compute-2", VCPUsUsed: 6, PhysicalVCPUs: 6, TotalVCPUsAllocatable: 12, RAMUsedMB: 1024, PhysicalRAMMB: 2048, TotalRAMAllocatableMB: 4096, DiskUsedGB: 20, PhysicalDiskGB: 100, TotalDiskAllocatableGB: 200},
			},
			expectedMetrics: []collectedVMwareMetric{
				...
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "cpu"), Value: 4},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "ram"), Value: 1024 * 1024 * 1024},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-1", "az1", "disk"), Value: 50 * 1024 * 1024 * 1024},
				...
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-2", "az2", "cpu"), Value: 6},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-2", "az2", "ram"), Value: 2048 * 1024 * 1024},
				{Name: "cortex_vmware_host_physical_capacity_total", Labels: hostCapacityLabels("nova-compute-2", "az2", "disk"), Value: 100 * 1024 * 1024 * 1024},
