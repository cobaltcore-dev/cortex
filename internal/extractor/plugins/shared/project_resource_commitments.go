...
// Feature to calculate the total resource (vcpu, ram) commitments of all projects.
...
func (ProjectResourceCommitments) TableName() string {
	return "feature_project_resource_commitments"
}

// Indexes for the feature.
func (ProjectResourceCommitments) Indexes() []db.Index { return nil }

// Extractor that extracts the resource commitments of all projects.
...
// Extract the resource commitments of all projects.
