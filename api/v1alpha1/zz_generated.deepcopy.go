...
func (in *CommittedResourceStatus) DeepCopyInto(out *CommittedResourceStatus) {
	*out = *in
	if in.AcceptedAmount != nil {
		in, out := &in.AcceptedAmount, &out.AcceptedAmount
		x := (*in).DeepCopy()
		*out = &x
	}
...
func (in *ProjectQuotaSpec) DeepCopyInto(out *ProjectQuotaSpec) {
	*out = *in
	if in.Quota != nil {
		...
		*out = make(map[string]ResourceQuota, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *ProjectQuotaStatus) DeepCopyInto(out *ProjectQuotaStatus) {
	*out = *in
	if in.TotalUsage != nil {
		...
		*out = make(map[string]ResourceQuotaUsage, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceQuotaUsage) DeepCopyInto(out *ResourceQuotaUsage) {
	*out = *in
	if in.PerAZ != nil {
		in, out := &in.PerAZ, &out.PerAZ
		*out = make(map[string]int64, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceQuotaUsage.
func (in *ResourceQuotaUsage) DeepCopy() *ResourceQuotaUsage {
	if in == nil {
		return nil
	}
	out := new(ResourceQuotaUsage)
	in.DeepCopyInto(out)
	return out
}
