...
func TestStoragePoolCPUUsageExtractor_Init(t *testing.T) {
	...
	if !testDB.TableExists(netapp.StoragePoolCPUUsage{}) {
...
func TestStoragePoolCPUUsageExtractor_Extract(t *testing.T) {
	...
	var cpuUsages []netapp.StoragePoolCPUUsage
	for _, f := range features {
		cpuUsages = append(cpuUsages, f.(netapp.StoragePoolCPUUsage))
	}

	expected := []netapp.StoragePoolCPUUsage{
