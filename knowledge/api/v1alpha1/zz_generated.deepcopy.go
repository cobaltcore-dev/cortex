...
func (in *OpenStackDatasource) DeepCopyInto(out *OpenStackDatasource) {
	*out = *in
	...
	out.KeystoneSecretRef = in.KeystoneSecretRef
}
...
func (in *PrometheusDatasource) DeepCopyInto(out *PrometheusDatasource) {
	*out = *in
	if in.TimeRangeSeconds != nil {
		in, out := &in.TimeRangeSeconds, &out.TimeRangeSeconds
		*out = new(int)
		**out = **in
	}
	...
	if in.ResolutionSeconds != nil {
		in, out := &in.ResolutionSeconds, &out.ResolutionSeconds
		*out = new(int)
		**out = **in
	}
}
